...
export default function LoginModal() {
    const { closeModal, handleSuccess, openRegister, openForgotPassword } = useAuthModal();
    ...
    const handleOAuth = async (provider) => {
        ...
        // OAuth redirects the browser; modal will close on return via onAuthStateChange
    };
    ...
    return (
        ...
        >
            ...
            >
                ...
                <p className="text-gray-500 text-sm mb-8">Sign in to your HansFlix account</p>
