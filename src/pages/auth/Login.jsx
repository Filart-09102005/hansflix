...
export default function Login() {
    ...
    return (
        <div className="relative min-h-screen flex flex-col justify-center items-center px-4 pt-16">
            ...
            <div className="relative w-full max-w-md bg-card/95 sm:backdrop-blur-2xl p-10 rounded-2xl border border-border shadow-[0_0_50px_rgba(0,0,0,0.5)] animate-fade-in-up">
                <h1 className="text-foreground text-3xl font-bold mb-8 tracking-tight">Welcome Back</h1>
